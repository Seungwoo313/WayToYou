...
> 이 PNG들은 `a6d5be9`의 framing별 마커 다리 분기 이전에 캡처했다. 카메라 확대 판정과 최종 framing 비교에는 계속 유효하지만, 현재 기본 지구 유지 조합은 프로필 아래 다리와 흰 위치 점이 보이고 초기 근거리 확대 조합은 캡처처럼 다리 없이 아바타 중심이 도시 좌표에 놓인다.
...
- 기본 지구본을 유지하면 마커의 흰 다리와 위치 점도 유지한다. 근거리 확대가 실제로 확정되면 다리와 점을 숨기고 아바타 중심 앵커로 전환한다.
